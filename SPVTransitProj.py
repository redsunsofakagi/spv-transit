...
def linked(): #moves the user to the data screen
    ...
    if str(user.get()) in ['STUPAR', 'ATTEN']  and str(passbox.get())!='' and str(userbox.get()) not in ['#Name of Passenger','#Name of Attendant']:
        ...
        canvas.create_window(615,80, window=button3)#places save
        canvas.pack()
...
pv1= map_widget.set_path([saketj.position,saketh.position,gyan.position,shivalik.position,malv1.position,sarv.position,swami.position,tito.position,sadiq.position,hudco.position,andrew.position,spv.position])
#pv2
dda=map_widget.set_marker(28.55627,77.17526, text="DDA Flats Munirka")
jnu=map_widget.set_marker(28.535,77.16933, text="JNU")
ber=map_widget.set_marker(28.55166,77.18212, text="Ber Sarai")
munmark=map_widget.set_marker(28.55469,77.17767, text="Munirka Market")
rkp=map_widget.set_marker(28.54888,77.18754, text="RK Puram Sector III")
iit=map_widget.set_marker(28.54602,77.19609, text="IIT Gate")
saf=map_widget.set_marker(28.55312,77.20155, text="Safdarjung Development Area")
gp1=map_widget.set_marker(28.56025,77.20341, text="Green Park")
kid=map_widget.set_marker(28.57275,77.20922, text="Kidwai Nagar")
jorb=map_widget.set_marker(28.58579,77.21262, text="Jor Bagh")
...
#pv5
sch=map_widget.set_marker(28.52911,77.21406, text="Saket City Hospital")
sksii=map_widget.set_marker(28.53353,77.23202, text="Sheikh Sarai II")
ski=map_widget.set_marker(28.53845,77.22284, text="Sheikh Sarai I")
hk1=map_widget.set_marker(28.54911,77.21011, text="Hauz Khas I")
asi=map_widget.set_marker(28.54805,77.21872, text="Asiad Village")
gul=map_widget.set_marker(28.55373,77.21222, text="Gulmohar Park")
nee=map_widget.set_marker(28.55797,77.21777, text="Neeti Bagh")
ayu=map_widget.set_marker(28.56109,77.22202, text="Ayurvigyan Nagar")
shi=map_widget.set_marker(28.56645,77.22502, text="Shiv Mandir")
